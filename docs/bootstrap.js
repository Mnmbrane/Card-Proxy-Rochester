...
eval("{// A dependency graph that contains any wasm must all be imported\n// asynchronously. This `bootstrap.js` file does the single async import, so\n// that no one else needs to worry about it again.\n__webpack_require__.e(/*! import() */ \"js_main_js\").then(__webpack_require__.t.bind(__webpack_require__, /*! ./js/main.js */ \"./js/main.js\", 23))\n  .catch(e => console.error(\"Error importing `js/main.js`:\", e));\n\n\n//# sourceURL=webpack://create-wasm-app/./bootstrap.js?\n}");
